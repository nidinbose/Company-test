...
const CreditCardOffer = () => {
  return (
    <div className="min-h-screen bg-gray-100  container mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12  mx-auto ">
        ...
        <div className="bg-white rounded-2xl shadow col-span-1 lg:col-span-3 p-6 space-y-6">
  ...
  <div className="flex flex-col justify-between space-y-2">
    <div>
      <h2 className="text-md md:text-xl lg:text-lg xl:text-[18px] font-bold text-indigo-900 mt-4 md:mt-1">
        Axis Bank Club Vistara Credit Card
      </h2>
      <p className="text-md md:text-lg text-indigo-900 mt-1">Travel</p>
  ...
  <div className="border-l-2 pl-6 text-sm text-gray-700 w-full md:w-fit">
    <div>
      ...
      <p className="text-xl font-bold text-black mt-1">₹ 500/-</p>
    </div>
    <div className="pt-4">
      <hr />
      <p className="text-gray-600 font-bold mt-2">Joining Fees</p>
      <p className="text-xl font-bold text-black mt-1">No Cost</p>
    </div>
    <div className="pt-4">
      <hr />
      <p className="text-gray-600 font-bold mt-2">Recommended Credit Score</p>
      <p className="text-xl font-bold text-black mt-1">550-600</p>
...
<hr />
       ...
       <h3 className="font-bold text-black text-lg mb-5">Welcome Offers</h3>
        ...
        <div className="bg-gray-100 p-4 space-y-4 col-span-1 h-full hidden lg:block">
        </div>
  ...
  <div className="flex flex-col justify-between space-y-2">
    <div>
      ...
      <p className="text-md md:text-lg text-indigo-900 mt-1">Dining & Shopping</p>
      <p className="text-indigo-900 mt-2 text-[10px] xl:text-[11px] font-medium">
      HDFC Times Titanium Credit Card offers a world of benefits tailored for your lifestyle. From accelerated rewards on dining and shopping to exclusive entertainment privileges, experience a card that enhances every moment, making your transactions more rewarding than ever.
      </p>
    </div>
...
<hr />
  ...
  <div className="flex flex-col justify-between space-y-2">
    <div>
      <h2 className="text-md md:text-xl lg:text-lg xl:text-[18px] font-bold text-indigo-900 mt-4 md:mt-1">
      Yes Bank Prosperity Credit Card
      </h2>
      <p className="text-md md:text-lg text-indigo-900 mt-1">Travel</p>
      <p className="text-indigo-900 mt-2 text-[10px] xl:text-[11px] font-medium">
      Elevate your travel experience with the Axis Bank Club Vistara Credit Card, offering exclusive Vistara airline privileges and accelerated rewards on every journey. Seamlessly blend luxury and convenience with a card designed for the
